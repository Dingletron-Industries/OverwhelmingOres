...
public class WealthyLapis extends Item {

    public WealthyLapis() { super(new Properties().group(OverwhelmingOres.ITEM_GROUP)); }
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add((new TranslationTextComponent("wealthy_lapis"))
